                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            <form method="post">
                                <div class="col-12">
                                    <label for="inputDel" class="ml-1"> Insira o ID do usuário que deseja deletar: </label>
                                    <input type="text" name="id-usuario" id="id-usuario" required>
                                    <button type="submit" name="pesquisar" class="btn btn-danger ml-4">Deletar</button>
                                </div>
                            </form>

                            <?php
                            require_once "../obj/obj_deletar_usuario.php";
                            ?>
                        </div>
                    </div>
